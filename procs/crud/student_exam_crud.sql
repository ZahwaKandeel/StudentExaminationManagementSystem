...
CREATE OR REPLACE PROCEDURE UpdateStudent(sx_id INT, t_grade INT DEFAULT 0)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE select_StudentExam(INOUT result REFCURSOR, sx_id INT DEFAULT NULL, s_id INT DEFAULT NULL, ex_id INT DEFAULT NULL, t_grade INT DEFAULT NULL)
LANGUAGE plpgsql
AS $$
BEGIN
    OPEN result FOR
